...
help:
	...
	@echo ""
	@echo "  make pdf              Build PDF from reports/final_report.md → reports/final_report.pdf"
...
clean:
	rm -rf reports/diagrams reports/_processed.md
	rm -rf output/diagrams output/_processed.md
